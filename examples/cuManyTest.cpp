...
int main(int argc, char** argv) {
    ...
    cuPaScaL_TDMA::cuPTDMAPlanMany px_many;
    px_many.create(nx, ny, nz, MPI_COMM_SELF, cuPaScaL_TDMA::TDMAType::Cyclic);
    cuPaScaL_TDMA::cuPTDMASolverMany::cuSolve(px_many, d_a, d_b, d_c, d_d);
    px_many.destroy();
