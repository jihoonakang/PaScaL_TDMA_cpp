program main
    ...
    call PaScaL_TDMA_plan_many_rhs_create(pz_many_rhs, nz, nx_sub * ny_sub, 0, 1, MPI_COMM_SELF, 0)
    call PaScaL_TDMA_many_rhs_solve(pz_many_rhs, az, bz, cz, d_sub)
    call PaScaL_TDMA_plan_many_rhs_destroy(pz_many_rhs)
    ...
    call PaScaL_TDMA_plan_many_rhs_create(py_many_rhs, ny_sub, nz * nx_sub, comm_1d_y%myrank, comm_1d_y%nprocs, comm_1d_y%mpi_comm, 0)
    call PaScaL_TDMA_many_rhs_solve(py_many_rhs, ay_sub, by_sub, cy_sub, d_sub_tr)
    call PaScaL_TDMA_plan_many_rhs_destroy(py_many_rhs)
    ...
    call PaScaL_TDMA_plan_many_rhs_create(px_many_rhs, nx_sub, ny_sub * nz, comm_1d_x%myrank, comm_1d_x%nprocs, comm_1d_x%mpi_comm, 0)
    call PaScaL_TDMA_many_rhs_solve(px_many_rhs, ax_sub, bx_sub, cx_sub, d_sub_tr)
    call PaScaL_TDMA_plan_many_rhs_destroy(px_many_rhs)
    ...
    if (is_root) then
        print *, "Avg. norm2 error = ", norm2(d - x) / nx / ny / nz
    endif
