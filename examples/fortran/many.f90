program main
    ...
    type(c_ptr) :: px_many, py_many   ! Plan for many tridiagonal systems of equations
    ...
    call PaScaL_TDMA_plan_many_create(py_many, ny_sub, nx_sub, comm_1d_y%myrank, comm_1d_y%nprocs, comm_1d_y%mpi_comm, 0)
    ...
    call PaScaL_TDMA_plan_many_create(px_many, nx_sub, ny_sub, comm_1d_x%myrank, comm_1d_x%nprocs, comm_1d_x%mpi_comm, 0)
